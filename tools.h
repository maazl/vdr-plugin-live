...
template<class T>
  ...
  template<typename... Args> void AppendFormatted(std::string &target, char const* format, Args&&... args) {
    char result[30];
  ...
  template<typename... Args> void AppendFormatted(cLargeString &target, char const* format, Args&&... args) {
